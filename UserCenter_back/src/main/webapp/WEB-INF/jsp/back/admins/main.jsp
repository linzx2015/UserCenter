...
<head>
	...
	<title>${sessionScope.admins.email}--用户中心</title>
	<link href="${rootPath}/dwz_jui/themes/default/style.css" 
		rel="stylesheet" type="text/css" media="screen"/>
	<link href="${rootPath}/dwz_jui/themes/css/core.css" 
		rel="stylesheet" type="text/css" media="screen"/>	
		...
		<div id="layout">
			<div id="header">
				<div class="headerNav">
					...
					<ul class="nav">
						<li><a href="#">${sessionScope.admins.email }</a></li>
						<li><a href="#">上次登陆时间:<fmt:formatDate value="${sessionScope.lastLoginTime }" pattern="yyyy-MM-dd HH:mm:ss"/></a></li>
						<!-- <li><a href="https://me.alipay.com/dwzteam" target="_blank">捐赠</a></li>
						<li id="switchEnvBox">
							<a href="javascript:">（<span>北京</span>）切换城市
						</a>
							<ul>
				...
				<div id="navMenu">
					<ul>
						<li class="selected"><a href="${rootPath }/back/admins/leftMenu.htm?operType=userManager"><span>用户管理</span></a></li>
						<li><a href="${rootPath }/back/admins/leftMenu.htm?operType=sysManager"><span>系统管理</span></a></li>
					</ul>
				</div>
			</div>
