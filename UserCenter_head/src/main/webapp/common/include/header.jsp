...
<div id="s_hdw">
			...
			<div class="tbar_lft">
				...
				<c:choose>
					<c:when test="${sessionScope.users!=null}">
						<a href="${rootPath}/head/users/main.html">${sessionScope.users.email}</a>
						<a href="${rootPath}/head/users/logout.html" onclick="return confirm('确认退出 吗?')">退出</a>
					</c:when>
					<c:otherwise>
						<a href="${rootPath}/login.html">请登录</a> | <a href="${rootPath}/register.html">免费注册</a>
					</c:otherwise>
				</c:choose>
			</div>
			<div class="tbar_rgt">
				<ul>
					...
					<li><a href="${rootPath}/head/users/main.html">我的KKK商城</a></li>
					<li><a href="#">帮助中心</a></li>
					<li><a href="#">联系客服</a></li>
					<li><a href="#">加入收藏</a></li>
	...
	<div class="s_hd nav">
		<div id="s_logo">
			<a href="#"><img src="${rootPath}/images/logo.jpg" border="0" /></a>
		</div>
		<div id="s_nav">
			<ul>
	...
	<div class="mmenu">
		<div class="s_hd">
			<div id="s_search">
				<form action="" method="post">
					<input name="" type="text" class="search-input" /><input name=""
						type="image" src="${rootPath}/images/btn_search.jpg" />
				</form>
			</div>
			...
			<div id="s_cart">
				<ul>
					<li class="nums"><a href="" id="s_cart_nums1">购物车： <span>0</span>
							件
					</a> <a href="" class="btn" id="s_cart_nums2"></a></li>
